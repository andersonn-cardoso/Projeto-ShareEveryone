<#Script que verifica compartilhamentos para todos "Share Everyone"
 ...
 #Criado em 05/2024 - By Anderson Cardoso
 #Funcionamento:
...
$FilenameLog = $domainPrefix +"_Share_Everyone"
    ...
    if (test-path $csvShares_history) 
       {
        ...
        if ($Compare -eq $true) 
            {ImprimirTextoEmRetangulo -Texto "Não há necessidade de gerar novo chamado para equipe Segurança da  Informação, pois o histórico é o mesmo"   -Largura 110 -Altura 5
                     ...
                     Send-EmailWithAttachment -from "E-mail-from-aqui@dominio.com.br" -to "E-mail-To@Dominio.com.br" -subject "Report Share Erveryone" -attachmentPath $csvShares -smtpServer servidorSMT.com.br -body "Report Share Erveryone" 
...
if ($Compare_FailedServers -eq $true) 
                   { ImprimirTextoEmRetangulo -Texto "Não há necessidade de gerar novo chamado para Sustentação, pois o histórico é o mesmo"   -Largura 90 -Altura 5
                            ...
                            Send-EmailWithAttachment -from "E-mail-from-aqui@dominio.com.br" -to "E-mail-To@Dominio.com.br" -subject "Report Servidores não contatados" -attachmentPath $csvFailedServers -smtpServer servidorSMT.com.br -body "Report de Servidores não contatados" 
